    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "🌷𝐃𝐨𝐬𝐭𝐚𝐧𝐚 ✘ 𝐌𝐚𝐧𝐚𝐠𝐞𝐫🌷 ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇᴅ ʙʏ {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "🌷𝐃𝐨𝐬𝐭𝐚𝐧𝐚 ✘ 𝐌𝐚𝐧𝐚𝐠𝐞𝐫🌷 ᴄʜᴀᴛʙᴏᴛ ᴇɴᴀʙʟᴇᴅ ʙʏ {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
